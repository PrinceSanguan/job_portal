    ...
    <div class="container-xxl bg-white p-0">
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            <a href="index.html" class="navbar-brand d-flex align-items-center text-center py-0 px-4 px-lg-5">
                <h1 class="m-0 text-primary">Work From Home</h1>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="joblisting.php" class="nav-item nav-link">Jobs</a>
                </div>
                        ...
                        <div id="tab-1" class="tab-pane fade show p-0 active">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <div class="d-flex mb-3">
                                            <a class="btn btn-light btn-square me-3" href="jobdetail1.php"><i class="far fa-heart text-primary"></i></a>
                                            <a class="btn btn-primary" href="jobdetail1.php">Apply Now</a>
                                        </div>
                            ...
                            <div class="job-item p-4 mb-4">
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <div class="d-flex mb-3">
                                            <a class="btn btn-light btn-square me-3" href="jobdetail2.php"><i class="far fa-heart text-primary"></i></a>
                                            <a class="btn btn-primary" href="jobdetail2.php">Apply Now</a>
                                        </div>
                            ...
                            <div class="job-item p-4 mb-4">
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <div class="d-flex mb-3">
                                            <a class="btn btn-light btn-square me-3" href="jobdetail3.php"><i class="far fa-heart text-primary"></i></a>
                                            <a class="btn btn-primary" href="jobdetail3.php">Apply Now</a>
                                        </div>
